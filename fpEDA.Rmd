...
happy21 |> group_by(Region) |> summarize(happyavg = mean(Happy)) |> arrange(happyavg)
...
Now visualize that on world map:
```{r}
...
Under hierarchical clustering, I found out that the clusters of regions similar in happiness level did not change much from 2020 to 2021, and that 
